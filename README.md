...
* **`NetworkRepair`:** UUse para falhas de resolução de nomes (DNS), sites que não carregam ou erros de "Servidor não encontrado". (Não altera configurações de IP Estático/Fixo).*.
